...
(function() {
  var MG, alias, ex, ex2, ref1, roman,
  ...
  MG.getChords = function(chord_str, oct, key_sig) {
    var chord_name, chord_pitches, lastIndex, r, ref2, root, root_pitch;
    if (key_sig == null) {
      key_sig = 'C';
    }
    if (oct == null) {
...
(function() {
  ...
  seqPlayer = (function() {
    ...
    seqPlayer.prototype.play = function(n) {
      ...
      loop1 = (function(_this) {
        return function() {
          var dur, notes;
          if (cur[0] > 0) {
            notes = typeof cur[1] === 'number' ? [cur[1]] : cur[1];
    ...
    seqPlayer.prototype.fromScore = function(src, contents) {
      ...
      q = this.toQ(obj.tracks[0], ctrlTicks, src.volumes[0]);
      t = this.toQ(obj.tracks[1], ctrlTicks, src.volumes[1]);
      this.tracks = [];
  ...
  this.AppMG = (function() {
    ...
    AppMG.prototype.parse = function() {
      ...
      return this.obj = this.player.fromScore(this.settings, this.contents);
    };
    ...
    AppMG.prototype.analysis = function(data, ctrl_per_beat) {
      ...
      tracks = q.map(function(track) {
        ...
        return Generator.prototype.b2score.call({}, res, ctrl_per_beat * settings.time_sig[0]);
      });
...
(function() {
  this.ScoreRenderer = (function() {
    ...
    ScoreRenderer.prototype.dur_obj = function(sum, dur) {
    ...
    ScoreRenderer.prototype.render = function(s) {
      ...
      for (i = l = 0, ref = melody.length; l < ref; i = l += 1) {
        ...
        later_tie = [];
        sum = 0;
        melody[i].forEach((function(_this) {
          return function(e) {
            var dur, durs, ii, indices, keys, n, pd, ref1, ref2, rest, start, tie;
            ref1 = _this.dur_obj(sum, 16 * e[0] / s.ctrl_per_beat), sum = ref1.sum, dur = ref1.dur;
            durs = [];
            pd = 0;
