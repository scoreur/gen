...
(function() {
  this.ScoreRenderer = (function() {
    ...
    ScoreRenderer.prototype.render = function(score, contents) {
      var beams, formatter, i, l, later_tie, melody, notes, num_beats, raw_w, ref, s, sharp, stave, sum, ties, toScale, voice, w;
      ...
      for (i = l = 0, ref = melody.length; l < ref; i = l += 1) {
        ...
        melody[i].forEach((function(_this) {
          return function(e) {
            ...
            ref1 = _this.dur_obj(sum, 8 * e[0] / s.ctrl_per_beat), sum = ref1.sum, dur = ref1.dur;
            durs = [];
            pd = 0;
