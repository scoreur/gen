...
(function() {
  var MG, _seed, alias, funcchords, funcmap, gcd, hmm_transit, lcm, ref1, roman,
  ...
  MG.schemaAdd = function(schema, ident, node, action) {
    if (node != null) {
  ...
  MG.chord_hmm = function(key_sig, hmm) {
    var gen, scale, states, transit;
    if (hmm == null) {
      hmm = hmm_transit;
    }
    states = ['I'];
...
(function() {
  ...
  this.Generator = (function() {
    ...
    Generator.prototype.gen_random = function(options) {
      var bass, choices, chorder, ctrl_per_beat, cur_chord, dur, h, harmony, i, info, j, k, key_sig, n, new_dur, nm, op, pre, pre2, range, range_dist, raw_choices, rc1, rc2, ref, ref1, ref2, res, scale_len, seed, seed2, swarp, time_sig, tmp, toPitch, toScale, v;
      dur = options.dur;
...
(function() {
  ...
  ScoreObj = this.ScoreObj = (function() {
    ...
    ScoreObj.prototype.toText = function(m) {
      var key_sigs, ref_oct, res, time_sigs, toScale;
      ...
      ref_oct = 4;
      res = m.map(function(e, e_i) {
        var durs, gcd, ret;
        ret = [];
        if (time_sigs[e_i] != null) {
          ret.push(':t' + time_sigs[e_i].join('/'));
        }
        if (key_sigs[e_i] != null) {
