...
(function() {
  ...
  this.Generator = (function() {
    ...
    Generator.prototype.generate = function() {
      var adjust, b, dur, e0, first_measure, first_note, i, l, last_block, last_measure, last_note, mode, pre_note, ref1, ref2, ref3, res, res_eval, sec, tonic;
      ...
      for (e0 in ref2) {
        ...
        console.log(res_eval[e0] = this.evaluate(this.b2score(b, this.settings.ctrl_per_beat)));
      }
      res = this.schema.structure.map(function(e) {
        return JSON.parse(JSON.stringify(res[e]));
      });
      this.res2 = res;
      console.log(res);
      for (i = l = 1, ref3 = res.length; l < ref3; i = l += 1) {
    ...
    Generator.prototype.gen_random = function(dur, options) {
      var choices, i, j, k, n, new_dur, pre, raw_choices, rc1, rc2, res, scale_len, seed, seed2, swarp, tmp, toPitch, toScale, v;
