    ...
    ScoreObj.prototype.parseTexture = function(measures) {
      ...
      res = measures.map(function(e) {
        ...
        arrange.forEach(function(e2) {
          var bass, chord, dur, e3, inv, j, refk, s, terms, tied, tmp, _i, _j, _ref1, _ref2, _ref3, _results;
          if (e2[0] === ':') {
            ...
            for (j = _i = inv, _ref2 = e2.length; _i < _ref2; j = _i += 1) {
              switch (s = e2[j]) {
                ...
                case '#':
                case 'b':
                  _results.push(refc[refc.length - 1] += {
                    '+': 12,
                    '-': -12,
                    '#': 1,
                    'b': -1
            ...
            tmp = [];
            for (j = _j = 0, _ref3 = terms[0].length; _j < _ref3; j = _j += 1) {
              e3 = terms[0][j];
              if (e3 === '^') {
                tied = true;
              } else if (refc[e3]) {
...
(function() {
  this.ScoreRenderer = (function() {
    ...
    ScoreRenderer.prototype.render = function(score) {
      var beams, ctx, dur_tot, formatter, i, notes, num_beats, raw_w, sharp, stave, voice, w, _i, _ref;
      this.r.resize(1000, 800);
      ...
      this.sys = [];
      for (i = _i = 0, _ref = this.s.melody.length; _i < _ref; i = _i += 1) {
