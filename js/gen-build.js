...
(function() {
  ...
  this.gen_modes = ['random', 'transpose', 'chord', 'reverse'];
  ...
  this.AppMG = (function() {
    ...
    AppMG.prototype.updateEditor = function() {
      return _.flatten(this.ui.editor).forEach((function(_this) {
        return function(e) {
          var ret;
          ret = _this.contents[e] != null ? _this.contents[e].join('\n') : JSON.stringify(_this[e], null, 2);
...
(function() {
  ...
  this.Generator = (function() {
    ...
    Generator.prototype.produce = function(variable, global) {
      var dependency, i, k, l, len, len1, len2, local, m, next_global, q, ref1, ref2, ref3, ref4, ret, v;
      if (variable.mode != null) {
        return this.gen_chord(variable.options);
      }
    ...
    Generator.prototype.generate = function() {
      var adjust, first_measure, first_note, i, l, last_block, last_measure, last_note, pre_note, ref1, res, res_eval, sec, tonic;
      sec = this.settings.ctrl_per_beat * this.settings.time_sig[0];
      res_eval = [];
      this.res2 = this.produce(this.schema).map((function(_this) {
        return function(b) {
