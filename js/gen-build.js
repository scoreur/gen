...
(function() {
  var MG, alias, gcd, lcm, ref1, roman,
...
(function() {
  ...
  this.AppMG = (function() {
    ...
    AppMG.prototype.updateEditor = function() {
      return _.flatten(this.ui.editor).forEach((function(_this) {
        return function(e) {
          var ret;
          if (e === 'schema') {
            ret = Generator.prototype.produceSchema(_this.schema);
    ...
    AppMG.prototype.generate = function() {
      var generator, score;
      this.settings = JSON.parse(this.editor.settings.getValue());
      this.schema = Generator.prototype.parseSchema(this.editor.schema.getValue());
...
(function() {
  ...
  parser = (ref1 = this.schema_parser) != null ? ref1 : require('./js/schema_parser');

  parser.produce = function(obj) {
    var indent, produce, produceVar;
    produceVar = function(o, indent) {
      var k, l, len, ret, tmp, v;
      if (indent == null) {
        indent = '';
      }
      ret = '';
        ...
        if (v.structure != null) {
          ...
          v.structure.forEach(function(e) {
            ...
            if ((v.action != null) && e in v.action) {
              ret += produceVar(v.action[e], indent);
            }
            return ret += '\n';
          });
          ret += indent + ';\n';
  ...
  this.Generator = (function() {
    var _seed, newChoices, obj_merge, rndPicker, seededRandom, top_sort;

    function Generator(settings, schema) {
      var base, base1, base2, k, ref2, v;
    ...
    Generator.prototype.evaluate = function(data) {
      ...
      if (MG.ref_midi_info !== null) {
        ...
        ref_beat_dur = _.reduce(ref_beat_dur, function(a, b) {
          return a + b;
        }, 0);
        info_dur = info.rhythm[0][0].split(',').map(function(ee) {
          return parseInt(ee);
        });
        info_dur = _.reduce(info_dur, function(a, b) {
          return a + b;
        }, 0);
    ...
    Generator.prototype.produce = function(variable, global) {
      var dependency, i, k, l, len, len1, len2, local, m, next_global, q, ref2, ref3, ref4, ref5, ret, v;
      ...
      ref4 = variable.action;
      for (k in ref4) {
        v = ref4[k];
        switch (v.mode) {
          case 'transpose':
            next_global[k] = this.gen_transpose(v, obj_merge(next_global[k]));
            break;
          case 'reverse':
            next_global[k] = this.gen_reverse(v, obj_merge(next_global[k]));
            break;
          case 'distribution':
            next_global[k] = v;
        }
    ...
    Generator.prototype.generate = function() {
      var adjust, first_measure, first_note, i, l, last_block, last_measure, last_note, pre_note, ref2, res, res_eval, sec, tonic;
      sec = this.settings.ctrl_per_beat * this.settings.time_sig[0];
      res_eval = [];
      this.res2 = this.produce(this.schema.S).map((function(_this) {
        return function(b) {
          return _this.b2score(b, sec);
        };
      })(this));
      console.log('produce', this.res2);
      res = this.res2;
      for (i = l = 1, ref2 = res.length; l < ref2; i = l += 1) {
      ...
      last_measure.sort(function(a, b) {
        return a[0] - b[0];
      });
      tonic = MG.key_class[this.settings.key_sig];
      last_note = last_measure[last_measure.length - 1][1];
      if (typeof last_note === 'object') {
        last_note = last_note[0];
      }
      adjust = modulo(tonic - (last_note % 12), 12);
      last_note += adjust;
    ...
    Generator.prototype.gen_transpose = function(options, src) {
      var cur_i, dur, interval, refd, res, tmp, tmp2, transpose;
      dur = options.dur;
      res = {
        dur: [],
        pitch: []
    ...
    Generator.prototype.gen_reverse = function(options, src) {
      var res;
      res = {
        dur: [],
        pitch: []
    ...
    Generator.prototype.gen_chord = function(options) {
      var choices, chords, cur_chord, dur, i, j, k, n, new_dur, pre, pre2, range, range_dist, raw_choices, rc1, rc2, refc, refdur, res, scale_len, seed, seed2, swarp, tmp, toPitch, toScale, v;
      dur = options.dur;
      toPitch = this.toPitch;
      toScale = this.toScale;
    ...
    Generator.prototype.b2score = function(b, sec, flat) {
      ...
      pitch = flat ? b.pitch : _.flatten(b.pitch, true);
      ret = [];
      tmp = [];
      delta = 0;
    ...
    rndPicker = function(choices, weights) {
      ...
      return {
        gen: function() {
          var m, r, ref3;
          r = seededRandom();
          for (i = m = 0, ref3 = p.length; m < ref3; i = m += 1) {
            if (r < p[i]) {
              return choices[i];
            }
          }
...
(function() {
  ...
  parser = (ref2 = this.score_parser) != null ? ref2 : require('./js/parser.js');
  ...
  this.ScoreObj = (function() {
    ...
    ScoreObj.prototype.parseHarmony = function(measures, tatum) {
      var key_sig;
